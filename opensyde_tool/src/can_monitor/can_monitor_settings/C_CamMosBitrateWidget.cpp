...
/*!
   \file
   \brief       Widget for configuring CAN bitrate (implementation)

   Widget for configuring CAN bitrate
...
#include "C_CamMosBitrateWidget.hpp"
#include "ui_C_CamMosBitrateWidget.h"
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_CamMosBitrateWidget::C_CamMosBitrateWidget(QWidget * const opc_Parent) :
   C_OgeWiOnlyBackground(opc_Parent),
   mpc_Ui(new Ui::C_CamMosBitrateWidget)
{
   ...
   connect(this->mpc_Ui->pc_ComboBoxBitrate, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged),
           this, &C_CamMosBitrateWidget::m_OnBitrateChanged);
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_CamMosBitrateWidget::~C_CamMosBitrateWidget()
{
   delete this->mpc_Ui;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamMosBitrateWidget::LoadUserSettings(void)
{
   // Load bitrate from user settings
   const int32_t s32_Bitrate = C_UsHandler::h_GetInstance()->GetCanBitrate();
   this->m_SetBitrateComboBox(s32_Bitrate);
   
   // Load and apply expand state to match Database widget behavior
   const bool q_Expanded = C_UsHandler::h_GetInstance()->GetWiDatabaseExpanded();
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_CamMosBitrateWidget::GetSelectedBitrate(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamMosBitrateWidget::m_InitUi(void)
{
   // initialize colors
   ...
   connect(this->mpc_Ui->pc_WiHeader, &C_CamOgeWiSettingSubSection::SigExpandSection,
           this, &C_CamMosBitrateWidget::m_OnExpand);
   connect(this->mpc_Ui->pc_WiHeader, &C_CamOgeWiSettingSubSection::SigHide,
           this, &C_CamMosBitrateWidget::SigHide);
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamMosBitrateWidget::m_OnExpand(const bool oq_Expand)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamMosBitrateWidget::m_SetBitrateComboBox(const int32_t os32_Bitrate)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamMosBitrateWidget::m_OnBitrateChanged(void)
{
   const int32_t s32_Bitrate = this->GetSelectedBitrate();
   
   // Save to user settings immediately
   C_UsHandler::h_GetInstance()->SetCanBitrate(s32_Bitrate);
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamMosBitrateWidget::OnCommunicationStarted(const bool oq_Online)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamMosBitrateWidget::PrepareForExpanded(const bool oq_Expand) const
{
   Q_UNUSED(oq_Expand)
